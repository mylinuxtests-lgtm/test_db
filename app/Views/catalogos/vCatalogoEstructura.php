    ...
    <div class="card">
        <div class="card-body">
            ...
            <table 
                ...
                data-method="post"
                data-query-params="queryParamsEstructura"               
                data-url="<?php echo base_url()."index.php/Catalogos/getEstructura" ?>"
                >
                <thead>
                    <tr>
                        ...
                        <th data-field="dsc_estructura" data-sortable="true"  >Descripción</th>  
                        <th data-field="id_padre" data-sortable="true"  >Depende de</th>                        
